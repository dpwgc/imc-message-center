...
public class InformationCommandServiceImpl implements InformationCommandService {
    ...
    public boolean createInformation(InformationCommand informationCommand) {
        ...
        Information information = informationFactory.create(snowUtil.nextIdString(),informationCommand.getAppId(),informationCommand.getGroupId(),informationCommand.getUserId(),informationCommand.getTitle(),informationCommand.getContent(),informationCommand.getJumpUrl(),informationCommand.getType());
